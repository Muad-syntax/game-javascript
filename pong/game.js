...
function update() {
    ...
    if (ball.y <= 0 || (ball.y + ballHeight >= boardHeight)) {
        ...
        ball.velocityY *= -1; //reverse direxton
    }
    ...
    if (detectCollision(ball, player1)) {
        ...
        if (ball.x + ballWidth >= player2.x) { //right side of ball touches right side of player 1 (left paddle)
            ball.velocityX *= -1; // flip x direction
        }
    }    
    ...
    //draw dotted line down the mddle
